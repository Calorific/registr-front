...
import { PatientName } from '@/shared/ui/AppointmentLayout/PatientName';
...
export const AppointmentLayout: FC<AppointmentLayoutProps> = ({ children, appointmentId, current }) => {
